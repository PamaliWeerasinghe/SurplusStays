    ...
    <div class="container">
        ...
        <div class="right">
            <div class="details">
                ...
                <h4>NEW PASSWORD :</h4>
                <input value="<?=get_var('new_password')?>" placeholder="ENTER YOUR NEW PASSWORD" type="password" class="input"  name="new_password" required>
                <h4>RE-ENTER PASSWORD :</h4>
                <input value="<?=get_var('renter_password')?>" placeholder="RE-ENTER YOUR PASSWORD" type="password" class="input"  name="renter_password"  required>
                <p style="margin-top: 8%;">Doesn't have an account?<a style="text-decoration: none;" href='<?=ROOT?>/register/register'>&nbsp;Register Now </a></p>
            </div>
            
            <button type="submit" class="register-button">RESET</button>
            </form>  
        </div>

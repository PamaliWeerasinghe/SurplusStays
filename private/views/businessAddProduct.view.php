                ...
                <div class="main-box">
                    ...
                    <form method="POST" enctype="multipart/form-data">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" value="<?= get_var('product-name') ?>" name="product-name" pattern="[A-Za-z\s]*" title="Only letters and spaces are allowed" placeholder="Enter The Product Name (E.G., Fresh Apples, Baked Bread)">
                        </div>

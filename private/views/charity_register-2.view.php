    ...
    <div class="container">
        ...
        <div class="right">
            <div class="details">
                ...
                <h4>PHONE NUMBER :</h4>
                <input placeholder="ENTER A PHONE NUMBER" type="text" class="input" >
                <h4>ORGANIZATION DESCRIPTION :</h4>
                <input placeholder="ENTER A BRIEF DESCRIPTION ABOUT THE ORGANIZATION" type="text" class="input">       
            </div>
            <button class="register-button" onclick="window.location.href='<?=ROOT?>/register/charity_step3'">NEXT</button>
        </div>
    </div>

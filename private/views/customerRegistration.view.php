    ...
    <div class="container">
        ...
        <form method="post" class="right" enctype="multipart/form-data"> <!--enctype="multipart/form-data" allows file uploads-->
            <div class="details">
                ...
                <h4>FIRST NAME :</h4>
                <input placeholder="ENTER YOUR ORGANIZATION NAME" value="<?=get_var('fname')?>" type="text" name="fname" class="input" >
                <h4>LAST NAME :</h4>
                <input placeholder="ENTER YOUR ORGANIZATION CITY" value="<?=get_var('lname')?>" type="text" name="lname" class="input">
                <h4>EMAIL ADDRESS:</h4>

    ...
    <div class="popup-container" id="rcpopup-container">
        ...
        <div class="popup" id="rcpopup">
            ...
            <div class="edit-delete">
                <span class="material-symbols-outlined" style="z-index:999;" id="edit_business" >
                    edit_square
                </span>
                <span class="material-symbols-outlined action-btn deactivate" style="color: red;" id="delete_business">
                    person_remove
                </span>

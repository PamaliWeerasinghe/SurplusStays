            ...
            <div class="top-nav">
                ...
                <div class="admin-order-status">
                        ...
                        <div class="order-dropdown">
                            <label class="order-status-label2">Bar Chart</label>
                            <select>
                    ...
                    <div class="product-summaries">
                            <div class="product-row">
                                <div class="product-item">
                                    ...
                                    <label class="product-summaries-label1">Keels</label>
                                    <label class="product-summaries-label2">52 donations</label>
                                    </div>
                                ...
                                <div class="product-item">
                                    ...
                                    <div class="product-summaries-item">
                                    <label class="product-summaries-label1">Glomark</label>
                                    <label class="product-summaries-label2">32 donations</label>
                                    </div>
                                ...
                                <div class="product-item">
                                    ...
                                    <div class="product-summaries-item">
                                    <label class="product-summaries-label1">Laughs Super</label>
                                    <label class="product-summaries-label2">12 Donations</label>
                                    </div>
                            ...
                            <div class="product-row">
                                <div class="product-item">
                                    ...
                                    <div class="product-summaries-item">
                                    <label class="product-summaries-label1">Elephant House</label>
                                    <label class="product-summaries-label2">5 Donations</label>
                                    </div>

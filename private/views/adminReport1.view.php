    ...
    <div class="report-container">
        ...
        <table class="report-table">
            ...
            <tbody>
                ...
                <tr>
                    <?php
                    $total_units=$total_units+$product->qty_saved + $product->left_overs;
                    $total_value=$total_value+$product->original_price * $product->qty_saved
                    ?>
                    
                    <td><?=$product->product_name?></td>
                    <td><?=$product->bus_name?></td>
                    <td><?=$product->qty_saved?></td>
                    <td><?=$product->qty_saved + $product->left_overs?></td>
        ...
        <div class="report-summary">
            <div class="summary-item">
                <span class="summary-label">Total Units Saved:</span>
                <span class="summary-value"> <?=$total_units?></span>
            </div>
            <div class="summary-item">
                <span class="summary-label">Total Value Saved:</span>

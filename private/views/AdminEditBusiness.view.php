    ...
    <div class="container">
        ...
        <form method="post" class="right" enctype="multipart/form-data">
            <div class="details">
                ...
                <h4>BUSINESS NAME :</h4>
                <input placeholder="<?=$rows->business_name?>" value='<?=get_var('name')?>' type="text" name="name" class="input" >
                
                <h4>BUSINESS LOGO :</h4>
                <div class="upload-wrapper">
                        <label for="upload-1">
                            <img src="<?=ASSETS?>/businessImages/<?=$rows->profile_pic?>" alt="Upload Image" class="upload-icon" id="profilePreview">
                        </label>
